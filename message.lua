...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading SaturnHub...")
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("SaturnHub/Blox Fruits/") then
			makefolder("SaturnHub/Blox Fruits/");
		end;
		if not isfile(("SaturnHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SaturnHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SaturnHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("SaturnHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("SaturnHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
...
MainTab:Button("Copy Discord Link", function()
	setclipboard("https://discord.gg/nuxzhekVHq");
